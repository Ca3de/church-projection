...
export function QuickDisplay({
  ...
  // Format text content - split into lines and paragraphs
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center max-w-5xl mx-auto w-full overflow-hidden">
        {contentType === 'image' ? (
          ...
          <div className="text-center animate-fade-in flex-1 overflow-y-auto max-h-[80vh] w-full px-4 scrollbar-thin">
            <div className="space-y-4">
              {formatText(content).map((line, index) => (
                <p
                  key={index}
